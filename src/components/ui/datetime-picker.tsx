...
export function DateTimePicker({
  ...
  const dislayFormat = useMemo(() => {
    if (!displayValue) return "Seleziona una data";
    return format(
      displayValue,
            ...
            <div>
              ...
              >
                {month
                  ...
                  .charAt(0)
                  .toUpperCase() +
                  month.toLocaleString("it-IT", { month: "long" }).slice(1)}
              </span>
              <span
                className="ms-1"
                onClick={() =>
              ...
              >
                {month.toLocaleString("it-IT", { year: "numeric" })}
              </span>
            </div>
            <Button
              variant="ghost"
      ...
      months.push({
        ...
        label:
          new Date(0, i)
            ...
            .charAt(0)
            .toUpperCase() +
          new Date(0, i).toLocaleString("it-IT", { month: "long" }).slice(1),
        disabled,
      });
    }
    return months;
